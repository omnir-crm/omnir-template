...
class Settings_SharingAccess_RuleMember_Model extends Vtiger_Base_Model
{
	...
	public static $ruleTypeLabel = array(
		self::RULE_MEMBER_TYPE_GROUPS => 'Groups',
		self::RULE_MEMBER_TYPE_ROLES => 'Roles',
		self::RULE_MEMBER_TYPE_ROLE_AND_SUBORDINATES => 'RoleAndSubordinates'
	);
